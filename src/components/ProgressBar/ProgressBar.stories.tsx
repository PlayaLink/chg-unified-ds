...
export const Overview: Story = {
  render: () => (
    <div className="flex w-[320px] flex-col gap-48 px-48 pb-48 pt-32">
      {/* Progress Values */}
      <div className="flex flex-col gap-16">
        <span className="text-sm font-medium text-gray-500">Progress Values</span>
      ...
      {/* Label Positions */}
      <div className="flex flex-col gap-16">
        <span className="text-sm font-medium text-gray-500">Label Positions</span>
        <div className="flex flex-col gap-24">
          <div className="flex flex-col gap-4">
            <span className="text-xs text-gray-400">No Label</span>
            <ProgressBar value={60} label={false} />
          </div>
          <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-4 pt-24">
            <span className="text-xs text-gray-400">Top Floating</span>
            <ProgressBar value={60} label="top-floating" />
          </div>
          <div className="flex flex-col gap-4 pb-24">
            <span className="text-xs text-gray-400">Bottom Floating</span>
            <ProgressBar value={60} label="bottom-floating" />
          </div>
        </div>
      </div>
    </div>
  ...
  render: () => (
    <div className="flex min-w-[420px] flex-col items-center gap-24">
      ...
      <div className="flex gap-12">
        <Button
          href="https://github.com/jordanchghealthcare/chg-unified-ds/tree/main/src/components/ProgressBar"
          target="_blank"
        ...
        <Button
          href="https://www.figma.com/design/r7KRvL85GNIIMn4iM9gKvo/Design-System--Components--Copy-?node-id=5282-681"
          target="_blank"
          rel="noopener noreferrer"
