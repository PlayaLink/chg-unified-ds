...
export const Overview: Story = {
  render: () => (
    <div className="flex w-[320px] flex-col gap-48 px-48 pb-48 pt-32">
      ...
      {/* Custom Labels */}
      <div className="flex flex-col gap-16">
        <span className="text-sm font-medium text-gray-500">Custom Labels</span>
        <div className="flex flex-col gap-12">
          <Slot>Header Slot</Slot>
          <Slot>Content Area</Slot>
          <Slot appearance="thin">Footer</Slot>
        </div>
      </div>
    </div>
  ),
  ...
  render: () => (
    <div className="flex min-w-[420px] flex-col items-center gap-24">
      ...
      <div className="flex gap-12">
        <Button
          href="https://github.com/jordanchghealthcare/chg-unified-ds/tree/main/src/components/Slot"
          target="_blank"
        ...
        <Button
          href="https://www.figma.com/design/r7KRvL85GNIIMn4iM9gKvo/Design-System--Components--Copy-?node-id=3585-1237"
          target="_blank"
          rel="noopener noreferrer"
