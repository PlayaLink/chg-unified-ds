  ...
  render: () => (
    <div className="flex flex-col gap-32">
      ...
      <div className="flex flex-col gap-8">
        ...
        <ActionMenu className="w-[232px]">
          <ActionMenu.Item icon={<EditIcon />}>Edit</ActionMenu.Item>
          <ActionMenu.Item icon={<CopyIcon />}>Duplicate</ActionMenu.Item>
          <ActionMenu.Item icon={<SettingsIcon />}>Settings</ActionMenu.Item>
          <ActionMenu.Divider />
          <ActionMenu.Item icon={<TrashIcon />}>Delete</ActionMenu.Item>
        </ActionMenu>
      </div>

      {/* With Disabled Item */}
      <div className="flex flex-col gap-8">
        <span className="text-sm font-medium text-gray-500">With Disabled Item</span>
        <ActionMenu className="w-[232px]">
          <ActionMenu.Item icon={<EditIcon />}>Edit</ActionMenu.Item>
          <ActionMenu.Item icon={<CopyIcon />} disabled>Duplicate</ActionMenu.Item>
          <ActionMenu.Divider />
          <ActionMenu.Item icon={<TrashIcon />}>Delete</ActionMenu.Item>
        </ActionMenu>
      </div>
...
export const Props: Story = {
  ...
  render: () => (
    ...
    >
      <ActionMenu.Item value="edit" icon={<EditIcon />}>Edit</ActionMenu.Item>
      <ActionMenu.Item value="duplicate" icon={<CopyIcon />}>Duplicate</ActionMenu.Item>
      <ActionMenu.Item value="settings" icon={<SettingsIcon />}>Settings</ActionMenu.Item>
      <ActionMenu.Divider />
      <ActionMenu.Item value="delete" icon={<TrashIcon />}>Delete</ActionMenu.Item>
    </ActionMenu>
  ),
}
  ...
  render: () => (
    <div className="flex min-w-[420px] flex-col items-center gap-24">
      ...
      <div className="flex gap-12">
        <Button
          href="https://github.com/jordanchghealthcare/chg-unified-ds/tree/main/src/patterns/ActionMenu"
          target="_blank"
        ...
        <Button
          href="https://www.figma.com/design/r7KRvL85GNIIMn4iM9gKvo/Design-System--Components--Copy-?node-id=34-989"
          target="_blank"
          rel="noopener noreferrer"
